...
<%-- Se ce un nomeutente lo stampo--%>
    <% if (isLogged) {%>
    <button class="my-3 px-3 float-right hover:border-2 rounded-lg"><a href="<c:url value="/personal"/>"><%= username %></a></button>
    <button class="my-3 px-3 float-right hover:border-2 rounded-lg"><a href="<c:url value="/logout"/>">Logout</a></button>
    <% } else { %>
